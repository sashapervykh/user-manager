...
export const ENV = {
  ...
  MAIL_HOST: checkEnv(ENV_NAMES.MAIL_HOST),
  MAIL_PORT: Number(checkEnv(ENV_NAMES.MAIL_PORT)),
  MAIL_REFRESH_TOKEN: checkEnv(ENV_NAMES.MAIL_REFRESH_TOKEN),
  MAIL_CLIENT_SECRET: checkEnv(ENV_NAMES.MAIL_CLIENT_SECRET),
  MAIL_CLIENT_ID: checkEnv(ENV_NAMES.MAIL_CLIENT_ID),
  GOOGLE_REDIRECT_URI: checkEnv(ENV_NAMES.GOOGLE_REDIRECT_URI),
};
